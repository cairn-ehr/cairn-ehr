...
> database, plus the two ports in `cairn-gui-data` and a six-patient mock population. 20 mutations
> run, 20 killed. **2b is the surface** — the Tauri commands, the shell state, an optional
