...
| [0002](0002-advisory-actor-write-contract.md) | Advisory-actor write contract (kastellan ↔ Cairn) | **Ran ✓** — C1–C5 PASS (PR #27) → [ADR-0029](../spec/decisions/0029-skill-epoch-as-pinned-actor-determinant.md)/[0030](../spec/decisions/0030-advisory-actor-integration-contract.md) | the advisory-tier integration contract: [ADR-0021](../spec/decisions/0021-layering-the-node-api-and-ui-pluralism.md)/[0022](../spec/decisions/0022-validated-submit-surface-the-write-path.md) floor-in-DB write path · [ADR-0007](../spec/decisions/0007-authorship-and-accountability.md)/[0010](../spec/decisions/0010-additive-vs-suppressing-classification.md) additive un-attested authorship · [ADR-0011](../spec/decisions/0011-actor-registry-version-pinning-and-key-custody.md) version-pinning + the parked skill-epoch refinement |
| [0003](0003-postgres-on-android-bionic-node.md) | A Cairn node on an Android phone (native bionic PostgreSQL 18 + pgrx) | **Ran 2026-06-25 — G0–G3 PASS** (full). Native PG 18.2 on stock Android 16 + a cross-built pgrx extension (incl. SPI); kit at [`poc/pg-android-kit/`](../../poc/pg-android-kit/) | the **fractal-topology** invariant at the phone tier · [ADR-0001](../spec/decisions/0001-fat-postgres-thin-daemon.md) Postgres-is-the-node · [ADR-0002](../spec/decisions/0002-in-database-rust-pgrx-escape-hatch.md) pgrx escape hatch on the node arch · [ADR-0021](../spec/decisions/0021-layering-the-node-api-and-ui-pluralism.md) substrate provenance invisible above the event-core socket |
| [0004](0004-iced-reference-ui-viability.md) | iced as the reference-UI framework — against an EHR's hard bars | **Harness built, awaiting human runs.** Pure core (multi-script shaping + latency stats) unit-tested in CI; A11y-tree / live-IME / Pi-latency passes operator-scripted; kit at [`poc/iced-ui-spike/`](../../poc/iced-ui-spike/) | the L3 reference-UI framework choice ([eval 0004](../ecosystem/0004-reference-ui-framework-iced-vs-tauri.md)): **accessibility** (AccessKit tree), **complex-text/IME** (cosmic-text shaping, [ADR-0014](../spec/decisions/0014-locale-pluggable-matcher-comparators.md) culture-neutrality), **paper-parity latency** ([§1.2](../spec/vision.md#12-the-paper-parity-test-normative)) on the tiny-skia Pi path · [ADR-0021](../spec/decisions/0021-layering-the-node-api-and-ui-pluralism.md) UI is a pure L3 producer, never on the inter-node path |
