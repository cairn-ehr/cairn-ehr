...
| [0002](0002-prescribing-vertical-slice.md) | Prescribing vertical slice — the active-write model, end to end on the Pi | Proposed | [ADR-0020](../spec/decisions/0020-active-write-thin-encounters-and-the-delete-vs-erase-distinction.md) active-write & twin-at-authoring · [ADR-0022](../spec/decisions/0022-validated-submit-surface-the-write-path.md) validated submit surface · [ADR-0008](../spec/decisions/0008-point-of-care-identity-possession-and-salvage.md) armed write-context · principle 3 (paper-parity, governing) · principle 4 (forced-manual) · principle 11 (the one artifact) |
