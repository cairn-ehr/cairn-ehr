...
over a real satellite link with nearly a second of round-trip delay, between two far corners of
Australia. These are not projections; they are passed tests.
