...
2. **Name tokens matched**, descending — how many DISTINCT query tokens equal a whole token of any of
   the candidate's retained, non-repudiated names, compared lowercased and NFC-normalised.
