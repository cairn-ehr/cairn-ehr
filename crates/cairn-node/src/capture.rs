//! Task 6 of #500 slice 2c — read one page of either plane's event set, and map a row to
//! the record the medium carries.
//!
//! This module is deliberately thin: `read_clinical_page` and `read_node_page` are one
